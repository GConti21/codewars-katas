...
public class CountPositivesSumNegativesTest {
    ...
    public void testNullInput() {
        assertArrayEquals(new int[0], CountPositivesSumNegatives.countPositivesSumNegatives(null));
    }

    @Test
    public void testEmptyInput() {
        assertArrayEquals(new int[0], CountPositivesSumNegatives.countPositivesSumNegatives(new int[0]));
    }
